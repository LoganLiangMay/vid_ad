...
exports.checkKlingTransitionsStatus = exports.generateKlingTransitions = void 0;
 ...
 */
exports.generateKlingTransitions = functions.https.onCall(async (data, context) => {
 ...
 */
exports.checkKlingTransitionsStatus = functions.https.onCall(async (data, context) => {
    const userId = context.auth?.uid || 'anonymous-user';
    try {
 ...
 */
async function getKlingVersion(replicate) {
...
//# sourceMappingURL=klingVideo.js.map