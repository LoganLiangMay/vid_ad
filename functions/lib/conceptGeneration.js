...
exports.generateConcepts = void 0;
...
const ConceptSchema = zod_1.z.object({
    ...
    narrativeArc: zod_1.z.string(),
    visualStyle: zod_1.z.string(),
    targetEmotion: zod_1.z.string(),
    sceneBreakdown: zod_1.z.array(zod_1.z.string()),
});
const ConceptsResponseSchema = zod_1.z.object({
    concepts: zod_1.z.array(ConceptSchema),
});
// ============================================
// GENERATE CONCEPTS FUNCTION
// ============================================
exports.generateConcepts = functions
    .runWith({
    timeoutSeconds: 300,
    memory: '1GB',
})
    ...
    try {
        ...
        if (!process.env.OPENAI_API_KEY) {
            ...
            const fallbackConcepts = generateFallbackConcepts(productName, productDescription, brandTone);
            res.status(200).json({
                success: true,
...
//# sourceMappingURL=conceptGeneration.js.map