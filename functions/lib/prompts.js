 ...
 */
function getSceneTimingGuideline(duration) {
    if (duration <= 10) {
 ...
 */
function generateUserPrompt(params) {
 ...
 */
function generatePrompt(params, version = 'v1.0') {
    // Validate parameters
 ...
 */
function generateVariationPrompt(params, variationNumber, totalVariations) {
 ...
 */
function validatePromptParams(params) {
    const errors = [];
    ...
    const validTones = ['professional', 'casual', 'playful', 'luxury', 'inspiring', 'urgent'];
